...
class robot:
    ...
    def sense(self):
        ...
        for ind in range(self.num_landmarks):
            ...
            dx = -self.x + self.landmarks[ind][0] - random.uniform(-1.0, 1.0) * self.measurement_noise
            dy = -self.y + self.landmarks[ind][1] - random.uniform(-1.0, 1.0) * self.measurement_noise
